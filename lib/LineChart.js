...
var LineChart = function (_React$Component) {
  ...
  _createClass(LineChart, [{
    ...
    value: function render() {
      ...
      var y = (0, _d3Scale.scaleLinear)().domain([0, 10]).range([chartHeight, 0]);
            ...
            _react2.default.createElement(
              ...
              function (interpolatedStyles) {
                return (
                  ...
                  _react2.default.createElement('path', { d: theLine(interpolatedStyles.map(function (c) {
                      return c ? c.style.y : 0;
                    })), stroke: '#0288d1', strokeWidth: '3px', fill: 'none' })
                );
              }
            )
          )
